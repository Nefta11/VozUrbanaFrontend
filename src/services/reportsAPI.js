...
let sampleReports = [
  {
    ...
    descripcion: "Gran fuga que está desperdiciando agua y afectando el tránsito",
    ...
    imagen: "https://images.pexels.com/photos/2590716/pexels-photo-2590716.jpeg?auto=compress&cs=tinysrgb&w=800",
    comentarios: [
      {
        id: 1,
  ...
  },
  {
    ...
    imagen: "https://images.pexels.com/photos/5396793/pexels-photo-5396793.jpeg?auto=compress&cs=tinysrgb&w=800",
    comentarios: []
  },
  {
    id: 3,
    titulo: "Basura acumulada en parque central",
    descripcion: "Hay montones de basura acumulada cerca de los juegos infantiles",
    categoria: "saneamiento",
    ...
    imagen: "https://images.pexels.com/photos/2768961/pexels-photo-2768961.jpeg?auto=compress&cs=tinysrgb&w=800",
    comentarios: [
      {
        id: 2,
  ...
  },
  {
    ...
    descripcion: "Hay una infestación de mosquitos que está causando problemas de salud",
    ...
    imagen: "https://images.pexels.com/photos/7788009/pexels-photo-7788009.jpeg?auto=compress&cs=tinysrgb&w=800",
    comentarios: []
  },
  {
    id: 5,
    titulo: "Semáforo descompuesto",
    descripcion: "El semáforo de la intersección lleva tres días sin funcionar, causando riesgo de accidentes",
    categoria: "seguridad",
    ubicacion: "Av. Juárez y Reforma, Huauchinango",
    latitud: 20.1836,
    longitud: -98.0503,
    estado: "en_proceso",
    prioridad: "alta",
    ...
    fecha_actualizacion: "2024-01-08",
    asignado_a: null,
    notas_admin: [],
    usuario: {
      id: 1,
    ...
    imagen: "https://images.pexels.com/photos/1097456/pexels-photo-1097456.jpeg?auto=compress&cs=tinysrgb&w=800",
    comentarios: [
      {
        id: 3,
        texto: "Ya vinieron a revisar, pero aún no está arreglado.",
        usuario: {
          id: 2,
          nombre: "Carlos Rodríguez"
        },
  ...
  },
  {
    ...
    descripcion: "Un árbol cayó después de la tormenta y está bloqueando completamente el paso peatonal",
    categoria: "medio_ambiente",
    ubicacion: "Calle Independencia #45, Nuevo Necaxa",
    latitud: 20.2086,
    longitud: -98.0336,
    estado: "nuevo",
    prioridad: "media",
    ...
    imagen: "https://images.pexels.com/photos/8851397/pexels-photo-8851397.jpeg?auto=compress&cs=tinysrgb&w=800",
    comentarios: []
  }
];
...
export const reportsAPI = {
  ...
  async assignReport(reportId, staffData) {
    ...
    const reportIndex = sampleReports.findIndex(r => r.id === Number(reportId))
  ...
  async addAdminNote(reportId, note) {
    ...
    sampleReports[reportIndex].fecha_actualizacion = new Date().toISOString().split('T')[0]
  ...
  async getByStatus(status) {
    ...
    const statusReports = sampleReports.filter(
      r => r.estado === status
    )
